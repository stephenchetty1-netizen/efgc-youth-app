...
This native Android shell opens the deployed **V88 EFGC Youth website** at
...
the “Build EFGC Youth V88 test APK” workflow's downloadable artifacts. To test:
open the successful run, download EFGC-Youth-V88-Android-APK, extract app-debug.apk
...
App ID: za.org.efgc.youth; version code 88.
